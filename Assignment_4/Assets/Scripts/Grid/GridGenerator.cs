...
public class GridGenerator : MonoBehaviour 
{
    ...
    [SerializeField] GameObject enemyPrefab;                     //enemy prefab to be spawned..
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                SpawnPlayerAndEnemy(x,z,position);
    ...
    public void SpawnPlayerAndEnemy(int x, int z, Vector3 position)
    {
        ...
        if (x == gridSizeX - 1 && z == gridSizeZ - 1)//spawning enemy on 10,10 tile..
        {
            Vector3 spawnPosition = new Vector3(position.x, position.y + 1, position.z);
